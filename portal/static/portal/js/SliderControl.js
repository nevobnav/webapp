L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        var sliderContainer_append = '<div id="leaflet-slider" style="width:'+ 50*this.options.no_of_layers+'px"><div class="ui-slider-handle"></div><div id="slider-timestamp" class="p-1 mb-2 bg-warning text-dark" style="width:'+ 50*this.options.no_of_layers+'px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>';
        $(sliderContainer).append(sliderContainer_append);
